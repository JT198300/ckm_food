...
Choose one `focus_tag` before writing this paragraph:

  if carb_impact is High Carb ........ focus_tag = High Carb
  else if carb_impact is Moderate Carb focus_tag = Moderate Carb
  else if fat_quality is MCT Rich ..... focus_tag = MCT Rich
  else if protein_support is Strong ... focus_tag = Strong Protein
  else if fat_support is Strong ....... focus_tag = Strong Fat
  else ................................ focus_tag = Very Low / Low Carb

This priority reflects the role most relevant to ketones. It chooses the focus
for paragraph 2 only; paragraph 1 may still describe the other composition
facts that define the food.
...
- micronutrients null → the information is unavailable. Omit every mention of
  those micronutrients; do not infer them from the food name and do not say
