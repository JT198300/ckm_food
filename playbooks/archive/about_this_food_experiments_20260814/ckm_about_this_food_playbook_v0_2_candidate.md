# CKM About This Food Playbook v0.2 Candidate
...
same breath. If adding a micronutrient makes the text too long, cut another
optional point. Skip it when nothing clears a threshold.
...
- Never expose internal enum strings or read displayed labels back.
