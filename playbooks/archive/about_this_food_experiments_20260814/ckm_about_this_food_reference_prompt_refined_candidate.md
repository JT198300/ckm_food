...
Choose ONE supplied tag for this paragraph. Then do two jobs, in this order:

  1. Explain that tag — why it holds, and what it means in practice
  2. Use that same tag's matching ketone landing, in ONE sentence, at the end

Do not switch to a second tag or combine landings from different tag rows.
