...
USUALLY PLAYS IN A MEAL — never what will happen to this person this time.
  ...
  High Carb     → "Carbs at that concentration are usually the part of a meal
                    that competes most with ketone production."
  Moderate Carb → "It contributes real carbohydrate; how much it competes
                    with ketone production depends on portion."
  Very Low/Low  → "With so few carbs, a food like this isn't usually what
                    moves ketones one way or the other."
  Strong Protein → "Protein does nudge ketones, but slowly and indirectly."
