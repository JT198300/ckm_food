# CKM About This Food Playbook v0.2.1 Candidate
...
aim near 50-60 words. Select the smallest useful set of exact nutrition values:
...
never what will happen to this person this time. Only the final sentence may
use the words `ketone`, `ketones`, `ketosis`, or their localized equivalents.
Do not mention them earlier and do not add another ketone conclusion.
...
mineral may be named without repeating its numeric value. Do not say the
